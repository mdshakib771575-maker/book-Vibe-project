...
const ReadListBook = () => {
     ...
     if(readListBook.length ===0 ){
       return <h2 className='text-3xl flex justify-center items-center bg-gray-200 p-20'>ReadList Book is Empty !</h2>
    
     }
    return (
        <div>
       
            <p> ReadListBook : {readListBook.length}</p>
        
             <div className='grid grid-cols-3 gap-4'>
                {
                    readListBook.map(book => <div key={book.bookId}>
